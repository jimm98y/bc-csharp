...
namespace TlsServerSample
{
    public class MockTlsServer
        : DefaultTlsServer
    {
        private readonly Certificate _certificate;
        private readonly AsymmetricKeyParameter _privateKey;

        internal MockTlsServer(Certificate certificate, Org.BouncyCastle.Crypto.AsymmetricKeyParameter privateKey)
        ...
        //{
        //    return new BcDefaultTlsCredentialedDecryptor((BcTlsCrypto)base.Crypto, _certificate, _privateKey);
        //}

        protected override TlsCredentialedSigner GetECDsaSignerCredentials()
        {
            return new BcDefaultTlsCredentialedSigner(new TlsCryptoParameters(m_context), (BcTlsCrypto)base.Crypto,
                _privateKey, _certificate, new SignatureAndHashAlgorithm(HashAlgorithm.sha256, SignatureAlgorithm.ecdsa));
        }
        ...
        //{
        //    return new BcDefaultTlsCredentialedSigner(new TlsCryptoParameters(m_context), (BcTlsCrypto)base.Crypto,
        //        _privateKey, _certificate, new SignatureAndHashAlgorithm(HashAlgorithm.sha256, SignatureAlgorithm.rsa));
        //}
